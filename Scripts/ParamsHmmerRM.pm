...
our @EXPORT_OK = qw($maxPercOutOverlap $maxRegionOutOverlap $maxPercCandidOutOverlap $distPredsHMMER $distPredsRepeatMasker $minLenPred $minLenPredHMMER $minLenPredRepeatMasker $pattLtrs $includeLTRs);


####### used in "extractHmmerRM.pl":
our $minLenPred = 20; # minimum length for ANY prediction to be included in the analyses (default = 20) - for the extraction ONLY.
