...
# If a sequence (whole or short) has not any domains with e-value equal or below the threshold ("$filterRpsBlast"), the ID of that sequence will NOT be shown in the output files.
...
#	- %filterTools: threshold for the predictions' e-values of RPS-Blast (default = 1.0e-05)
