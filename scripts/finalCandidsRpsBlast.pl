...
# Usage: perl finalCandidsRpsBlast.pl file_with_conserved_domains


# The input file can be generated by the script "extractRPSB.pl", which extracts and formats the predictions from the output file of RPS-Blast.
...
#	- $distPredsRPSB: maximum distance between 2 predictions to consider them inside the SAME candidate (default = 1300);
